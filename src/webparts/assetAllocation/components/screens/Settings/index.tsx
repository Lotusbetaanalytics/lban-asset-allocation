    ...
    <div className='background container'>
      ...
      <div className='container--info'>
        ...
        <div className='settings'>
            ...
            {/* <DashboardCard title="Manage Other Property" Icon={FaCheckCircle} url="/app/settings" titleClassName="settings__card__title" /> */}
            {section == "hr" && <DashboardCard title="Manage Office Managers" Icon={FaClipboard} url={`${sectionUrl}settings/om/manage`} titleClassName="settings__card__title" />}
            {section == "hr" && <DashboardCard title="Manage HR Managers" Icon={FaLayerGroup} url={`${sectionUrl}settings/hr/manage`} titleClassName="settings__card__title" />}
        </div>
